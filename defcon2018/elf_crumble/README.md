...
In the end of the game, I paseted payloads above into hex file from `broken` and reverted it. `xxd` is very powerful tool. It doesn't care of space and a new line when it revert text to binary. So you can just roughly paste!
